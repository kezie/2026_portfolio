...
const projects = [
  {
    ...
    tools: 'Python, React.js, CMS API, n8n, claude.ai',
    duration: '3 weeks',
    client: 'Marketing Agency',
    results: 'Automated multiple processes freeing up 240 man-hours per week',
  },
  {
    ...
    tools: 'Google Ads, React.js, CMS API, Google Search Console, Ahrefs, JSON-LD, Google Rich Results Test',
    duration: '3 Years',
  ...
  },
  {
    ...
    role: 'SEO Consultant',
    tools: 'React, TypeScript, Vercel, Shopify Storefront API, JSON-LD, Google Rich Results Test',
    duration: '3 Months',
  ...
  },
  {
    ...
    tools: 'Node.js, CMS API, Amazon AWS, Anaconda, Python',
    duration: '9 Months',
    client: 'Political Party',
    results: '+47% Audience Growth',
  },
  {
    ...
    description: 'Ground-up design and build of a scalable SaaS web application. Engineered the full stack — from a React.js App Router front-end with server components, to a REST API layer in Node.js/Express, with a PostgreSQL database. Baked in SEO from day one: SSR, metadata APIs, and structured data.',
